...
g++ -std=c++11 -g -o test main.cpp video_writer.cpp  data_manager.cpp myUtility.cpp decoder.cpp mySocket.cpp timer.cpp libRS_FFT.a thread_core_affinity_set.cpp -lpthread
